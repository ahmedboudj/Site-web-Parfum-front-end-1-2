    ...
    <div className={`${styles.header} d-flex flex-row align-items-center`}>
      ...
      <ul>
        {user && (
          <li>
            <NavLink
              className={`${styles.link} hover_opacity ajouter_produits mr-10`}
              to="/admin/add"
            >
              <span className={styles.text}>Ajouter un Parfums</span>
            </NavLink>
          </li>
        )}
        <li>
          ...
          <span
            ...
            className={`${styles.text} hover_opacity ajouter_produits mr-10`}
          >
            Panier
          </span>
        </li>
